        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El componente formativo aborda los fundamentos de los peligros y riesgos biológicos en entornos laborales, destacando su impacto en la salud y seguridad de los trabajadores. Se describen los agentes biológicos (virus, bacterias, hongos, parásitos), las vías de transmisión (fluidos, mordeduras, excrementos) y las estrategias de prevención y control (bioseguridad, EPP, vacunación). Incluye una clasificación por niveles de riesgo, analiza escenarios laborales expuestos y enfatiza la importancia de una gestión integral. Promueve la formación continua y el desarrollo de una cultura preventiva alineada con normativas de salud ocupacional.
